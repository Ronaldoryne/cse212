...
public static class Recursion
{
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        for (int i = 0; i < letters.Length; i++)
        {
            ...
            // Create new string without the current character
            string remainingLetters = letters.Remove(i, 1);
            // Recursively build permutation with current character added
    ...
    public static decimal CountWaysToClimb(int s, Dictionary<int, decimal>? remember = null)
    {
        ...
        // Recursive case: solve using recursion with memoization
    ...
    {
        // Base case: if no wildcards left, add the pattern to results
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // Check if we've reached the end (value 2 in the maze)
        if (maze.IsEnd(x, y))
        {
            // Found a solution - add to results
        ...
        // No need to manually remove from currPath since we create new copies for each recursive call
    }
}